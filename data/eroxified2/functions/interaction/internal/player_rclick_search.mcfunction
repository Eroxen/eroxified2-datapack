...
execute as @e[type=interaction,tag=eroxified2.interaction,predicate=eroxified2:interaction/rclicked,distance=..8] at @s run function eroxified2:interaction/internal/verify_rclick

execute if score #interaction.responder eroxified2.internal matches 0 run return 0

execute as @e[type=interaction,tag=eroxified2.interaction.responder,distance=..8,limit=1] at @s run function eroxified2:interaction/internal/get_rclicked