...
execute store success score #different eroxified.internal run data modify storage eroxified2:internal phead.scan_head.namespaced_id set from storage eroxified2:internal phead.context_internal.namespaced_id
execute if score #different eroxified.internal matches 1 run return 0

# return if the head already has a phead.block marker in place
scoreboard players set #return eroxified.internal 0
...
execute if score #return eroxified.internal matches 1 run return 0
