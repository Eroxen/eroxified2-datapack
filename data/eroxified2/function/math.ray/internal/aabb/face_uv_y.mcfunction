...
execute if score #math.ray.horizontal_rotation eroxified2.internal matches 0 run scoreboard players operation math.ray.hit.u eroxified2.api -= #math.ray.box.x.min eroxified2.internal
...
execute if score #math.ray.horizontal_rotation eroxified2.internal matches 1 run scoreboard players operation math.ray.hit.u eroxified2.api -= #math.ray.box.z.min eroxified2.internal
...
execute if score #math.ray.horizontal_rotation eroxified2.internal matches 2 run scoreboard players operation math.ray.hit.u eroxified2.api = #math.ray.box.x.max eroxified2.internal
...
execute if score #math.ray.horizontal_rotation eroxified2.internal matches 3 run scoreboard players operation math.ray.hit.u eroxified2.api = #math.ray.box.z.max eroxified2.internal
